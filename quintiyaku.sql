...
-- Tiempo de generación: 12-06-2023 a las 21:45:48
...
INSERT INTO `eventos` (`id`, `titulo`, `subtitulo`, `cuerpo`, `img_id`) VALUES
(1, 'Larreta oficializó el uso de las Taser en la Ciudad', 'El jefe de gobierno porteño presentó un cargamento de 60 pistolas que estarán en funcionamiento a partir de junio.', 'El jefe de gobierno porteño y precandidato a presidente por Juntos por el Cambio, Horacio Rodríguez Larreta, oficializó hoy el uso de pistolas Taser en la ciudad de Buenos Aires. En el marco de la presentación, Larreta apunto contra el Gobierno.«El Gobierno que encabeza Cristina Kirchner y Alberto Fernández fracasó. No pueden hablar de nada», planteó luego de anunciar que el cargamento de 60 armas se utilizará para controlar contextos masivos.Desde el Centro de Monitoreo Urbano situado en Chacarita, explicó: «La Ciudad por fin tiene las primeras 60 pistolas Taser que entre junio y julio van a entrar en acción, después de tanto tiempo donde hubo hechos lamentables que podríamos haber evitado, el Gobierno Nacional se dignó a habilitarnos las importaciones».', NULL),
...
(5, 'prueba11', 'prueba1', 'prueba1', NULL),
(6, 'aaaaaaa', 'aaaaaaaaaaaaa', 'aaaaaaaa', 'sblzemmzkagtuffnsiab'),
(7, 'bvbvbv', 'bv', 'bvbvbv', 'ennjebdyuhxctuvaplfl');
...
(1, 'lautaro', '81dc9bdb52d04dc20036dbd8313ed055');
COMMIT;
